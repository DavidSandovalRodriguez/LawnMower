...
struct area jardines[1];     //GUARDAR MEMORIA PARA 2 JARDINES
    ...
    if (parsed) {
      ...
      if (strcmp(action, "GET") == 0) {
       ...
       String lectura = String(path);
        lectura = lectura.substring(lectura.indexOf("?")+1);
  
        jardinNuevo.puntos[i]=lectura;
...
void loop(void)
{
  ...
  if (client) {
    ...
    if (parsed) {
      ...
      Serial.print(F("Action: ")); Serial.println(action);
      Serial.print(F("Path: ")); Serial.println(path);
      comando=String(path).substring(String(path).indexOf("?")+1,String(path).indexOf("="));
      Serial.print(F("comando: ")); Serial.println(comando);
 ...
 if (comando == "jardin"){ 
  ...
  Serial.println(jardines[0].puntos[0]);
  Serial.println(jardines[0].puntos[1]);
  Serial.println(jardines[0].puntos[2]);
  Serial.println(jardines[0].puntos[3]);
  Serial.println(jardines[0].puntos[4]);
